...
class AlertGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Alert entity")
        ...
        .repeat(2) {
            ...
            .post("/api/alerts")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "generated_on":"SAMPLE_TEXT", "version":"SAMPLE_TEXT", "system_id":"SAMPLE_TEXT", "serial_num":"SAMPLE_TEXT", "hostname":"SAMPLE_TEXT", "sequence":"0", "snmp_location":"SAMPLE_TEXT", "partner_system_id":"SAMPLE_TEXT", "partner_serial_num":"SAMPLE_TEXT", "partner_hostname":"SAMPLE_TEXT", "boot_clustered":"SAMPLE_TEXT", "alerts":null}""")).asJSON
            .check(status.is(201))
